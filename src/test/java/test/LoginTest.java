...
public class LoginTest extends BaseTest{
    ...
    public Object[][] incorrectFieldDataProvider() {
        return new Object[][]{
                { "mzub.test@gmail.comq", "1111", "We don't recognize that email.\n" + "Did you mean: @gmail.com?", ""},
                { "mzub.test@gmail.com", "testtest", "", "Hmm, that's not the right password. Please try again or request a new one."},
                { "mzub.test@amazos.com", "1111", "We don't recognize that email.\n" + "Did you mean: @amazon.com?", ""},
                { "mzub.test@linkedinn.com", "1111", "We don't recognize that email.\n" + "Did you mean: @linkedin.com?", ""},
                { "1243", "1111", "Be sure to include \"+\" and your country code.", ""},
                { "+1234", "1111", "Hmm, we don’t recognize that phone number. Please try again", ""},
                { "mzub.test1@gmail.com", "q0w9e8r7", "Hmm, we don't recognize that email. Please try again.", ""},
                { "test", "1111", "Please enter a valid email address.", ""},
                { "mzub.test@iicloud.com", "1111", "We don't recognize that email.\n" + "Did you mean: @icloud.com?", ""}
        };
    }
